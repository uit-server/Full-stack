    ...
    return(
        <div className="flex justify-between gap-x-1 gap-y-10 w-full flex-wrap mb-10">
            {data1.map((data,index)=>(
                <Link to={`/faculties/${data.link}`} key={index} className="bg-[#077d81] 2xl:w-[350px] xl:w-[300px] w-[155px] h-[208px]  2xl:h-[308px] flex items-center  py-[64px] px-[32px] rounded-[32px]">
