...
// const itemsData = [
//   { id: 1, name: 'Network Systems(NETsys) Lab', },
//   { id: 2, name: 'Vision and Learning Lab' },
//   { id: 3, name: 'High Performance Computing(HPC) Lab' },
//   { id: 4, name: 'Data Distribution Management (DDM) Lab' },
//   { id: 5, name: 'Deep Learning and Information Systems Lab' },
...
//               <div className='2xl:w-[550px] xl:w-[380px] xl:h-[380px] w-[300px] h-[350px] rounded-[32px]' style={{backgroundImage: `${Network}`, backgroundSize: 'cover', aspectRatio: 16/9, objectFit: 'cover', backgroundPosition: 'center center'}}></div>
