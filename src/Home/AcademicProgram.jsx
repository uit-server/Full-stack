...
function AcademicProgram() {
  ...
  return (
    <div className='lg:px-[10%] lg:py-[72px]'>
      <h1 className='lg:text-[72px] text-[32px] font-[400] lg:pb-[40px] lg:pt-0 py-[5%] lg:text-start text-center'>Academic Programs</h1>
      <div className='lg:flex lg:flex-row flex-col'>
        <div className='flex-grow lg:w-1/2 w-full lg:p-[0] px-[13%]'>
          <div className='lg:w-[70%] w-full flex flex-col h-full bg-gray-100 lg:p-[5%] '>
            <Link
            ...
            >
              <svg className='lg:h-[100px] h-[50px]' width='200' height='100' viewBox='0 0 129 101' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <path
              ...
              <div className='flex-grow w-full text-center lg:text-[47px] text-[32px] lg:leading-[48px] leading-[32px]'>Degree &nbsp; Program</div>
            </Link>
            <Link  
              className='flex items-center py-[5%]'
            ...
            >
              ...
              <div className='flex-grow w-full text-center lg:text-[47px] text-[32px] lg:leading-[48px] leading-[32px]'>Diploma &nbsp; Program</div>

            </Link>
          </div>
        </div>
        <div className='flex-grow lg:w-1/2 w-full lg:p-[0] px-[10%] lg:text-[20px] font-[400] text-justify items-center justify-center leading-[28px] '>
